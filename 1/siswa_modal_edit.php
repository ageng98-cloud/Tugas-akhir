							...
							<div class="form-group">
								<label>Nama Siswa</label>
									<div class="input-group">
										...
										<input name="Nama_siswa" autocomplete="off"  type="text" class="form-control" value="<?php echo $siswa["Nama_siswa"]; ?>"/>
									</div>
							</div>
							<div class="form-group">
								<label>Semester</label>
									<div class="input-group">
										...
										<input name="Semester" type="text"  autocomplete="off" class="form-control" value="<?php echo $siswa["Semester"]; ?>"/>
									</div>
							</div>
							<div class="form-group">
								<label>Tahun Ajaran</label>
									<div class="input-group">
										...
										<input name="Tahun_ajaran" type="text"  autocomplete="off" class="form-control" value="<?php echo $siswa["Tahun_ajaran"]; ?>"/>
									</div>
							</div>
							<div class="form-group">
								<label>Jurusan</label>
									<div class="input-group">
										<div class="input-group-addon">
										 ...
										 <select id="jurusan1" class="form-control" name="jurusan1" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')"  >
								...
								<label>Kelas</label>
									<div class="input-group">
										<div class="input-group-addon">
										 ...
										 <select id="kelas1" class="form-control" name="kelas1" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')" >
                                                <option value=>Please Select</option>
                                                <?php
							...
							<div class="form-group">
								<label>Alamat Siswa</label>
									<div class="input-group">
										...
										<input name="Alamat_siswa" autocomplete="off" type="text" class="form-control" value="<?php echo $siswa["Alamat_siswa"]; ?>"/>
									</div>
							</div>
							<div class="form-group">
								<label>No HP Siswa</label>
									<div class="input-group">
										...
										<input name="No_hp_siswa" autocomplete="off"  type="text" class="form-control" value="<?php echo $siswa["No_hp_siswa"]; ?>"/>
									</div>
							</div>
							<div class="form-group">
								<label>Nama Wali Siswa</label>
									<div class="input-group">
										...
										<input name="Nama_wali_siswa" autocomplete="off"  type="text" class="form-control" value="<?php echo $siswa["Nama_wali_siswa"]; ?>"/>
									</div>
							</div>
							<div class="form-group">
								<label>No HP wali siswa</label>
									<div class="input-group">
										...
										<input name="No_hp_wali_siswa" autocomplete="off" type="text" class="form-control" value="<?php echo $siswa["No_hp_wali_siswa"]; ?>"/>
									</div>
							</div>
							<div class="form-group">
									<div class="input-group">
										<input name="photo" type="hidden" autocomplete="off" class="form-control" value="<?php echo $siswa["photo"]; ?>" />
									</div>
							</div>
