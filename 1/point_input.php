						...
						<form action="point_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
							<div class="form-group">
									<div class="input-group">
										<input name="Id_pelanggaran_siswa" type="hidden"  autocomplete="off" class="form-control" value="<?php echo $pelanggaran["Id_pelanggaran_siswa"]; ?>" readonly />
									</div>
							</div>
							<div class="form-group">
								<label>NIS siswa</label>
									<div class="input-group">
										...
										<select class="select2_single form-control" tabindex="-1" name="NIS_siswa" id="NIS_siswa"  onchange="changeValue(this.value)">
											<?php
												...
												while($siswa = mysqli_fetch_array($querysiswa)){
													echo "
														<option value='$siswa[NIS_siswa]'>$siswa[Nama_siswa]</option>";
											$jsArray .= "Pnt['" . $siswa['NIS_siswa'] . "'] = {nama:'" . addslashes($siswa['Nama_siswa']) ."'};\n"; 
												}
							...
							<div class="form-group">
									<div class="input-group date">
										<input class="form-control" id="siswa" type="hidden" name="siswa" autocomplete="off" />
									</div>
							...
							<div class="form-group">
								<label>Tanggal</label>
									<div class="input-group date">
										...
										<input id="Tanggal_pelanggaran_siswa" name="Tanggal_pelanggaran_siswa" autocomplete="off" type="date" class="form-control" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
									</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>POINT</label>
									<div class="input-group date">
										...
										<input class="form-control" id="point" name="point" autocomplete="off" />
									</div>
									
									<script type="text/javascript">    
									<?php echo $jsArray; ?>  
									function changeValue(Nama_pelanggaran){  
									document.getElementById('point').value = Pnt[Nama_pelanggaran].nama;    
									};  
									 </script> 
							...
							<div class="form-group">
								<label>Keterangan</label>
									<div class="input-group">
										...
										<input name="Keterangan" type="text" class="form-control" autocomplete="off" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')"/>
									</div>
							</div>
