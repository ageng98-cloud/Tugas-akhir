				...
				<tbody>
					<?php
						...
						$querysiswa = mysqli_query ($konek, "SELECT siswa.NIS_siswa,siswa.Nama_siswa,kelas.Nama_kelas  FROM siswa JOIN kelas ON siswa.Kode_kelas = kelas.Kode_kelas ORDER BY siswa.Kode_kelas asc ");
						if($querysiswa == false){
