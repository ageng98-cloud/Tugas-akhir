...
while ($data = mysql_fetch_array($hasil))
{
  ...
  if ($pecah[0] == "PELANGGARAN")
  {
     ...
     $query2 = "SELECT Keterangan FROM pelanggaran_siswa WHERE NIS_siswa = '$pel'";
     ...
     if (mysql_num_rows($hasil2 )==0) $reply = "NIS tidak tidak terdaftar, silahkan cek kembali NIS siswa ";
     else
     {
        // bila pelangggaran ditemukan
       
	    $data2 = mysql_fetch_array($hasil2);
        $nilai = $data2['Keterangan'];
