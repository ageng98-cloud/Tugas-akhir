...
$cek = mysqli_num_rows(mysqli_query($konek,"SELECT Id_pelanggaran_siswa from pelanggaran_siswa WHERE Id_pelanggaran_siswa='$_POST[Id_pelanggaran_siswa]'"));
    ...
    mysqli_query($konek,"INSERT INTO pelanggaran_siswa (Id_pelanggaran_siswa, NIS_siswa,Tanggal_pelanggaran_siswa,Kode_pelanggaran,Keterangan) VALUES 
	('$Id_pelanggaran_siswa','$NIS_siswa','$Tanggal_pelanggaran_siswa','$Kode_pelanggaran','$Keterangan')");
