...
$Sampai=$_POST['Sampai'];
$NIP =$_POST ['NIP'];
$tampil = "SELECT * FROM pelanggaran_siswa LEFT JOIN pelanggaran USING (Kode_pelanggaran) LEFT JOIN siswa USING (NIS_siswa)LEFT JOIN kelas USING (Kode_kelas)  WHERE pelanggaran_siswa.NIP = $NIP AND Tanggal_pelanggaran_siswa BETWEEN '$Dari' AND '$Sampai' ORDER BY kelas.Nama_kelas;";
