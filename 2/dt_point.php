				...
				FROM pelanggaran_siswa JOIN pelanggaran ON pelanggaran.Kode_pelanggaran = pelanggaran_siswa.Kode_pelanggaran JOIN siswa ON siswa.NIS_siswa = pelanggaran_siswa.NIS_siswa JOIN kelas ON siswa.Kode_kelas = kelas.Kode_kelas where pelanggaran_siswa.NIP=$NIP ");
